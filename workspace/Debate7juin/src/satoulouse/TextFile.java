...
public class TextFile {
    ...
    public static ArrayList<String> lire_dans_un_fichier_lignes(String filePath) throws FileNotFoundException, IOException {
        ...
        public static String selectTextFile(Window w){
    ...
    public static void string_ecrire_dans_fichier(String text, String fichier_nom) throws IOException {
        BufferedWriter fichier = new BufferedWriter(new FileWriter(fichier_nom, true));
        fichier.write(text);
        fichier.newLine();
        fichier.close();
    }
  ...
  public static FileFilter getFileFilterSave() {
