...
public class FormulaBox extends javax.swing.JPanel {
    ...
    static private String formulaSchemeToLatexCode(Formula formula) throws Exception {
        if (formula.getString().startsWith("<")) {
            return "?";
        } else if (!formula.getString().startsWith("(")) {
            return formula.getString();
        } else if (formula.getString().equals("top")) {
            return "\\top";
        } else if (formula.getString().equals("bottom")) {
            return "\\bot";
        } else if (formula.getSubFormula(0).getString().equals("not")) {
            return "\\neg " + formulaSchemeToLatexCode(formula.getSubFormula(1));
        } else if (formula.getSubFormula(1).getString().equals("and")) {
    ...
    private void initComponents() {
        ...
        txtFormula.setText(null); // NOI18N
        txtFormula.setAlignmentX(0.0F);
        txtFormula.setFont(new Font("Tahoma", Font.BOLD, 18)); // NOI18N
        ...
        lblError.setBackground(new Color(255, 255, 153)); 
        lblError.setFont(new Font("Tahoma", Font.BOLD, 11)); 
        lblError.setForeground(new Color(255, 0, 0)); 
        lblError.setText("affichage"); 
        lblError.setName("lblError"); 
        add(lblError);

        lblAffichage.setText(null); 
        lblAffichage.setName("lblAffichage"); 
    ...
    /**
     * Permet de vérouiller la saisie de la formule
     */
    public void lockFormula () {
