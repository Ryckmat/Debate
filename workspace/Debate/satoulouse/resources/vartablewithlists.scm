...
;vÃ©rifie si la table contient la variable v
...
;ajoute la variable v dans la table t (l'entier correspondant est gÃ©nÃ©rÃ©)
...
(define (table-getvar? t i)
  (if (null? t)
      ...
      (if (equal? (cadr (car t)) i)
          (car (car t))
          (table-getvar? (cdßşSİ$s€Œ²XIW³¬Œ¯i(ŒèFf»…<ó¾§–›¬ˆ©ng¿„5¡™ÓQd^WĞ`ÖQ1ŞFçrr_U